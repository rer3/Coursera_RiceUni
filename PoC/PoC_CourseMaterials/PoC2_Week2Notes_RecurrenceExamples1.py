...
Week 2: Class Notes
Recurrence Examples 1: Binary Numbers and Binary Search
"""
#=================================================================
...
def run_bin_example(num):
    ...
    for length in range(5):
        ...
        for item in make_binary(length):
            print item
        print
    
run_bin_example(4)

print "Compute recurrence for binary numbers of specified length."
print "-"*58
...
for length in range(10):
    print "Length of", length, "= recurrence of", binary_length(length)
print

# Second example for running time of binary search

print "Compute search time using binary search."
print "-"*40
